...
//  int i;
  PlyFile *plyfile;
  PlyElement *elem = NULL;  ++elem;  // to silence unused warning
  char *name;
  FILE *fp;
...
PlyFile *ply_read(FILE *fp, int *nelems, char ***elem_names)
{
  ...
  int nwords;
  char **words;
  int found_format = 0;   ++found_format;  // to silence unused warning
  char **elist;
  PlyElement *elem;
  char *orig_line;
...
{
  int i;
  plyfile = NULL;  ++plyfile;   // silence unused warning
  PlyProperty *prop;
  int size = 0;
  int type_size;
