...
Rectangle* 
Rectangle::clone(void) const { return (new Rectangle(*this)); }
// ---------------------------------------------------------------- copy constructor
...
void 								
Rectangle::set_sampler(Sampler* sampler) { sampler_ptr = sampler; }
...
Normal 										
Rectangle::get_normal(const Point3D&) { return (normal); }
// ---------------------------------------------------------------- pdf

float
Rectangle::pdf(ShadeRec&) {	return (inv_area); }
